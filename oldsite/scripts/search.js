...
function openSearch() {
    ...
    console.log("openSeeaaaaaaaaaaaarch!");
}
...
function outerClick() {
    ...
    document.addEventListener('click', function(e) {
        var target = e.target;
        if (target !== searchInput && !searchContainer.contains(target)) {
